...
public class ResourceSkillDAO implements Skill_DAO {

    private ResultSet rs;

    private void getAll() throws SQLException {
        Connection conn = DB_Connection.getConnection();
        String query = "SELECT * FROM App_Skill";
    ...
    public ResourceSkillDAO() throws SQLException {
        getAll();
    }
    @Override
    ...
    public List<Skill> getSkills(Long id) throws SQLException {
        ...
        Connection conn = DB_Connection.getConnection();
        String query = "SELECT * FROM App_Skill WHERE appID = ?";
        PreparedStatement statement = conn.prepareStatement(query,ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
